...
void OptiLabCore::applyModeAndDerivedParameters(){
    const bool foundationGuardWasActive=foundationMix>0.0000001;
    ...
    if((foundationMix>0.0000001)!=foundationGuardWasActive)foundationGuard.reset();
